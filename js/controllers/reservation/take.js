 ...
 * @Last Modified by:   wu 
 * @Last Modified time: 2018-02-01 16:36:20 
 */
'use strict';
...
//	
	...
	$scope.outMark = function(){
		...
		console.log($scope.data.checked_items);
		//   打印凭条
		$scope.statusFn1();
	...
	var printLog = function(){
		//  alert('取预约单详情')
		// log
		window.terminal && window.terminal.WriteLog('res 预约取号 /api/yytMace/v1/printLog:' + JSON.stringify({lid: $scope.res_jfPrint.lid}));
		//
...
//  * 预约 取消预约
//  */
// app.controller('reservationCancelCtrl', function($scope,$interval,httpService) {
