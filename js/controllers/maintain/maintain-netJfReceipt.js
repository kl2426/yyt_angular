 ...
 *  维护人员相关界面 - 缴费凭条补打
 */
app.controller('modalMaintainNetJfReceiptCtrl', function($scope, $interval, $modal, $modalInstance, items, $filter, httpService, $timeout, globalFn) {
	...
	$scope.bhc = function() {
		...
		receiptList('BHC_Main_JH2303', $scope.items.scope.app.user_info.card_no, $scope.data.form.regDate);
	};
