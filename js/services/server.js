 ...
 * @Last Modified by:   wu 
 * @Last Modified time: 2018-02-01 16:38:16 
 */
...
var audio_list_fn = function(){
	var data_array = [
		...
		{ "id": "audio_026", "name": "请选择您要查询的方式", "src": "img/mp3/请选择您要查询的方式.ogg" },
		{ "id": "audio_027", "name": "请选择您要查看的报告单", "src": "img/mp3/请选择您要查看的报告单.ogg" },
		{ "id": "audio_028", "name": "请输入您要查询的日期", "src": "img/mp3/请输入您要查询的日期.ogg" },
		{ "id": "audio_029", "name": "请选择缴费的处方或点击缴费按钮进行全部缴费", "src":"img/mp3/请选择缴费的处方或点击缴费按钮进行全部缴费.ogg"},
		];
